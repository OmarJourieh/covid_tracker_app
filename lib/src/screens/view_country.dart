...
class CountryScreen extends StatelessWidget {
  final AmericanState country;
  CountryScreen({this.country});
  CovidCountryRecord _countryData;
                ...
                if (snapshot.hasData) {
                  return SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        _dataRecord("Country", country.name, width),
                        _div(width),
                        _dataRecord(
                            "Total Cases",
                            formatter.format(data.positive ?? -1).toString(),
                            width),
                        _div(width),
                        _dataRecord(
                            "New Cases",
                            formatter
                                .format(data.positiveIncrease ?? -1)
                                .toString(),
                            width),
                        _div(width),
                        _dataRecord(
                            "Negative Tests",
                            formatter.format(data.negative ?? -1).toString(),
                            width),
                        _div(width),
                        _dataRecord(
                            "New Negative Results",
                            formatter
                                .format(data.negativeIncrease ?? -1)
                                .toString(),
                            width),
                        _div(width),
                        _dataRecord(
                            "Total Deaths",
                            formatter.format(data.death ?? -1).toString(),
                            width),
                        _div(width),
                        _dataRecord(
                            "New Deaths",
                            formatter
                                .format(data.deathIncrease ?? -1)
                                .toString(),
                            width),
                        _div(width),
                        _dataRecord(
                        ...
                        _dataRecord(
                            "Currently in ICU",
                            formatter
                                .format(data.inIcuCurrently ?? -1)
                                .toString(),
                            width),
                        _div(width),
                        _dataRecord("Updated",
                            data.lastModified ?? "-1".toString(), width),
                        _div(width),
                      ],
                    ),
                  );
